...
Every core item from the coverage map must have all five coverage stages present in the world graph:
...
If a core item doesn't have all five stages, add worlds or levels until it does.
